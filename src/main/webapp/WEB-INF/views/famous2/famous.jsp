		...
		<div class="container">
			<div class="intro">
				...
				<div class="intro-text left-0 text-center bg-faded p-5 rounded">
					...
					<c:if test="${ empty sessionScope.loginMember }">
					<div class="intro-button mx-auto">
						<a class="btn btn-primary btn-xl" href="${ pageContext.servletContext.contextPath }/detailMove5.do">상세 정보</a>
					</div>
					</c:if>
					<!-- 로그인 한 경우 -->
					<c:if test="${ !empty sessionScope.loginMember and sessionScope.loginMember.admin_ok eq 'N'}">
		...
		<div class="container">
			<div class="intro">
				...
				<div class="intro-text left-0 text-center bg-faded p-5 rounded">
					...
					<c:if test="${ empty sessionScope.loginMember }">
					<div class="intro-button mx-auto">
						<a class="btn btn-primary btn-xl" href="${ pageContext.servletContext.contextPath }/detailMove6.do">상세 정보</a>
					</div>
					</c:if>
					<!-- 로그인 한 경우 -->
					<c:if test="${ !empty sessionScope.loginMember and sessionScope.loginMember.admin_ok eq 'N'}">
		...
		<div class="container">
			<div class="intro">
				...
				<div class="intro-text left-0 text-center bg-faded p-5 rounded">
					...
					<c:if test="${ empty sessionScope.loginMember }">
					<div class="intro-button mx-auto">
						<a class="btn btn-primary btn-xl" href="${ pageContext.servletContext.contextPath }/detailMove7.do">상세 정보</a>
					</div>
					</c:if>
					<!-- 로그인 한 경우 -->
					<c:if test="${ !empty sessionScope.loginMember and sessionScope.loginMember.admin_ok eq 'N'}">
		...
		<div class="container">
			<div class="intro">
				...
				<div class="intro-text left-0 text-center bg-faded p-5 rounded">
					...
					<c:if test="${ empty sessionScope.loginMember }">
					<div class="intro-button mx-auto">
						<a class="btn btn-primary btn-xl" href="${ pageContext.servletContext.contextPath }/detailMove8.do">상세 정보</a>
					</div>
					</c:if>
					<!-- 로그인 한 경우 -->
					<c:if test="${ !empty sessionScope.loginMember and sessionScope.loginMember.admin_ok eq 'N'}">
		...
		<div class="container">
			<div class="intro">
				...
				<div class="intro-text left-0 text-center bg-faded p-5 rounded">
					...
					<c:if test="${ empty sessionScope.loginMember }">
					<div class="intro-button mx-auto">
						<a class="btn btn-primary btn-xl" href="${ pageContext.servletContext.contextPath }/detailMove10.do">상세 정보</a>
					</div>
					</c:if>
					<!-- 로그인 한 경우 -->
					<c:if test="${ !empty sessionScope.loginMember and sessionScope.loginMember.admin_ok eq 'N'}">
