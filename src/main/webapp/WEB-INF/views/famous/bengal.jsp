				...
				<div style="background: #f6e1c5; border-radius: 0.25rem; border-radius: 0.5rem;border: 1px solid #e6a756; padding: 5px; margin: 5px;">
				 ...
				 <img style="float: right; width: 150px; height: 150px;" class="intro-img mb-3 mb-lg-0 rounded" 
					src="${ pageContext.servletContext.contextPath }/resources/static/img/bengal.jpg"
					 />
				 <br>	
				 	야생고양이와 집고양이가 브리딩된 고양이. 유일하게 야생고양이와 집고양이가 성공적으로 짝지어진 뱅갈 고양이. 표범을 떠올리게 하는 아름답고 화려한 무늬가 특징이다. 조용하고 은밀하게 움직이는 야생고양이의 특성을 받아 우아한 몸짓을 자랑한다. <br><br><br><br>
 				 </div>
 				 ...
 				 <h5 style="margin-left:4%;">벵갈 고양이의 성격?</h5>
 				 ...
 				 <br>
 				 	<h6>▶ 벵갈고양이는 친근하고, 애교가 많으며 다정한 성격이다. 수다를 떨거나, 사람의 무릎 위에 앉는 것을 좋아하는 대표적인 '개냥이'로 꼽히기도 한다. </h6><br>
 				 	<h6>▶ 엄청난 호기심과 활동량을 가진 벵갈고양이는 야생 살쾡이의 혈통임을 나타내기라도 하듯 사냥 본능도 매우 뛰어나다.더불어 야외 활동이 가능한 고양이이기도 하다.</h6><br>
 				 	<h6>▶ 먹잇감을 쫓으며 잡으려는 성향이 강하기 때문에 만약 가정에 햄스터나 기니피그, 토끼 등 소형 반려동물과 함께 살고 있다면 주의해야 한다.</h6><br>
 				 	<h6>▶ 하지만 사람을 좋아하고 온순하기 때문에 어린 아이와도 잘 어울리고, 강아지나 다른 동물과도 무리 없이 지낼 수 있는 매력적인 고양이이다</h6><br>
				</div>
